...
public class MyCardGame
{
    public static void main( String[] args)
    {
        ...
        if( game.isGameOver() )
        {
        	System.out.println( "Game is over the winners are : " );
        	System.out.println( game.getwinners() );
        }
        else
        {
        	
        	System.out.println( "Game is not over and so far winners are : " );	
        	System.out.println( game.getwinners() [0]);
        	System.out.println( game.getwinners() [1]);
        	System.out.println( game.getwinners() [2]);
        	System.out.println( game.getwinners() [3]);
